...
kubectl set image deploy hello-deploy-pod1 hello=docker.io/brainupgrade/hello:2.0 # Rollout (update pods) make new replica contains updated pods but old replica stills because if we want Rollback
```
